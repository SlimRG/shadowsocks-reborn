...
namespace Shadowsocks.Controller
{
    public class ShadowsocksController
    {
        ...
        protected void Reload()
        {
            ...
            {
                logger.Warn($"No Shadowsocks server is configured. Proxy relay will stay inactive until a server is added. Configuration file: {Configuration.ConfigFilePath}");
            }
