...
namespace Shadowsocks.Controller.Service
{
    ...
    internal static class OnlinePacCache
    {
        ...
        private static readonly string CachePath = Path.Combine(Shadowsocks.Engine.RuntimeEnvironment.WorkingDirectory, "online-pac-cache.pac");
        private static readonly string MetadataPath = Path.Combine(Shadowsocks.Engine.RuntimeEnvironment.WorkingDirectory, "online-pac-cache.meta.json");
