    ...
    public class PACDaemon
    {
        ...
        internal string TouchUserRuleFile()
        {
            if (!File.Exists(USER_RULE_FILE))
                File.WriteAllText(USER_RULE_FILE, Shadowsocks.Engine.EmbeddedResources.UserRule);
        ...
        private void WatchPacFile()
        {
            ...
            PACFileWatcher = new FileSystemWatcher(Shadowsocks.Engine.RuntimeEnvironment.WorkingDirectory)
            {
        ...
        private void WatchUserRuleFile()
        {
            ...
            UserRuleFileWatcher = new FileSystemWatcher(Shadowsocks.Engine.RuntimeEnvironment.WorkingDirectory)
            {
                NotifyFilter = NotifyFilters.LastWrite | NotifyFilters.FileName | NotifyFilters.DirectoryName,
