...
namespace Shadowsocks.Controller.Service
{
    ...
    public static class GeositeUpdater
    {
        ...
        private static readonly string LegacyDatabasePath = Path.Combine(Shadowsocks.Engine.RuntimeEnvironment.WorkingDirectory, "dlc.dat");
        private static readonly string CacheDirectory = Path.Combine(Shadowsocks.Engine.RuntimeEnvironment.WorkingDirectory, "geosite-cache");
