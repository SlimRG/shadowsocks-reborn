...
namespace Shadowsocks.Model
{
    ...
    public class Configuration
    {
        ...
        [JsonIgnore]
        public static string ConfigFilePath => Path.Combine(Shadowsocks.Engine.RuntimeEnvironment.WorkingDirectory, CONFIG_FILE);
#if DEBUG
        ...
        public static void Save(Configuration config)
        {
            ...
            try
            {
                configFileStream = File.Open(ConfigFilePath, FileMode.Create);
