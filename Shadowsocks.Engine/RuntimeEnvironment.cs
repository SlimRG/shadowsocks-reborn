...
{
    /// <summary>
    /// Process/runtime information required by the engine. The UI initializes this once
    /// during startup so engine code never needs to depend on Program, WinForms or WPF.
    /// </summary>
