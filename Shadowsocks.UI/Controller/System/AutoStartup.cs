...
namespace Shadowsocks.Controller
{
    static class AutoStartup
    {
        ...
        private static string Key = "shadowsocks-reborn_" + Utils.GetDeterministicHashCode(Shadowsocks.Engine.RuntimeEnvironment.ExecutablePath);
        ...
        public static bool Set(bool enabled)
        {
            ...
            try
            {
                ...
                if (enabled)
                {
                    runKey.SetValue(Key, Shadowsocks.Engine.RuntimeEnvironment.ExecutablePath);
                }
                else
                {
        ...
        public static bool Check()
        {
            ...
            try
            {
                ...
                foreach (var valueName in runKey.GetValueNames())
                {
                    ...
                    if (Shadowsocks.Engine.RuntimeEnvironment.ExecutablePath.Equals(runKey.GetValue(valueName).ToString(), StringComparison.InvariantCultureIgnoreCase))
                    {
        ...
        public static void RegisterForRestart(bool register)
        {
            ...
            if (register && !Check())
            {
                ...
                string[] args = new List<string>(Shadowsocks.Engine.RuntimeEnvironment.Arguments)
