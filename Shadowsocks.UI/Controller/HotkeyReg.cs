...
namespace Shadowsocks.Controller
{
    static class HotkeyReg
    {
        ...
        public static void Initialize(ShadowsocksController value) => controller = value ?? throw new ArgumentNullException(nameof(value));
        private static Logger logger = LogManager.GetCurrentClassLogger();
        public static void RegAllHotkeys()
        {
            var hotkeyConfig = controller.GetCurrentConfiguration().hotkey;
            ...
            else
            {
                ...
                MessageBox.Show(I18N.GetString("Register hotkey failed"), I18N.GetString("shadowsocks-reborn"));
            }
        }
