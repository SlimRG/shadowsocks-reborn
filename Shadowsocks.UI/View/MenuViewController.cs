...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        private System.Windows.Window versionUpdatePromptWindow;
        ...
        public MenuViewController(ShadowsocksController controller)
        {
            ...
            updateChecker = new UpdateChecker(controller);
        ...
        private void UpdateTrayIconAndNotifyText()
        {
            ...
            string text = I18N.GetString("shadowsocks-reborn") + " " + UpdateChecker.Version + "\n" +
                          (enabled ?
        ...
        {
            MessageBox.Show(e.GetException().ToString(), I18N.GetString("shadowsocks-reborn Error: {0}", e.GetException().Message));
        }
        ...
        void configForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            if (config.firstRun)
            {
                ...
                ShowBalloonTip(
                    I18N.GetString("shadowsocks-reborn is here"),
                    I18N.GetString("You can turn on/off shadowsocks-reborn in the context menu"),
                    ToolTipIcon.Info,
                    0
                );
        ...
        {
            var result = Shadowsocks.UI.QrCodeScanner.ScanFromScreen();
            if (result != null)
            {
        ...
        {
            await controller.UpdatePACFromGeositeAsync();
        }
        ...
        void controller_UpdatePACFromGeositeCompleted(object sender, GeositeResultEventArgs e)
        {
            ...
            ShowBalloonTip(I18N.GetString("shadowsocks-reborn"), result, ToolTipIcon.Info, 1000);
        }
        ...
        {
            File.WriteAllText(I18N.I18N_FILE, Shadowsocks.Engine.EmbeddedResources.I18nCsv, Encoding.UTF8);
        }
        ...
        private void updateChecker_UpdateAvailable(object sender, UpdateAvailableEventArgs e)
        {
            _uiDispatcher.Invoke(() =>
            {
                ...
                {
                    versionUpdatePromptWindow = new System.Windows.Window
                    {
                        ...
                        MinHeight = 480,
                        MinWidth = 640,
                        Content = new VersionUpdatePromptView(e.Release, updateChecker, CloseVersionUpdatePromptWindow)
                    };
                    versionUpdatePromptWindow.Closed += (_, _) => versionUpdatePromptWindow = null;
        ...
        private void CloseVersionUpdatePromptWindow()
        {
        ...
        void updateChecker_CheckUpdateCompleted(object sender, EventArgs e)
        {
            ...
            {
                ShowBalloonTip(I18N.GetString("shadowsocks-reborn"), I18N.GetString("No update is available"), ToolTipIcon.Info, 5000);
            }
