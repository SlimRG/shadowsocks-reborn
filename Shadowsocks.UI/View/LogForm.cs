...
namespace Shadowsocks.View
{
    public partial class LogForm : Form
    {
        ...
        {
            Shadowsocks.UI.WinFormsLocalization.TranslateForm(this);
        ...
        private void LogForm_Load(object sender, EventArgs e)
        {
            ...
            Width = config.Width;
            int safeWidth = Math.Max(config.Width, 400);
            int safeHeight = Math.Max(config.Height, 200);
            Top = Screen.PrimaryScreen.WorkingArea.Height - safeHeight;
            Left = Screen.PrimaryScreen.WorkingArea.Width - safeWidth;
            if (config.Maximized)
            {
