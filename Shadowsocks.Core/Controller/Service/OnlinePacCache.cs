...
namespace Shadowsocks.Controller.Service
{
    ...
    internal static class OnlinePacCache
    {
        ...
        private static readonly string CachePath = AppStoragePaths.OnlinePacCacheFile;
        private static readonly string MetadataPath = AppStoragePaths.OnlinePacMetadataFile;
