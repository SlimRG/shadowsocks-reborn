...
namespace Shadowsocks.Controller
{
    ...
    internal sealed class TCPHandler : IDisposable
    {
        ...
        // each recv size.
        public const int RecvSize = TransportBufferSizes.ReceiveSize;

        // overhead of one chunk, reserved for AEAD ciphers
        public const int ChunkOverheadSize = TransportBufferSizes.ChunkOverheadSize;

        // max chunk size
        public const uint MaxChunkSize = TransportBufferSizes.MaxChunkSize;

        // In general, the ciphertext length, we should take overhead into account
        public const int BufferSize = TransportBufferSizes.BufferSize;
